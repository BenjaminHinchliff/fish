...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" show-ref "3.9"
  WORKING_DIRECTORY "C:/Users/benja/source/repos/fish/out/build/x64-Release/_deps/pdcurses-src"
...
if("${show_ref_output}" MATCHES "refs/remotes/3.9")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "3.9")
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/wmcbrine/PDCurses.git'")
  endif()
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/benja/source/repos/fish/out/build/x64-Release/_deps/pdcurses-src'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/benja/source/repos/fish/out/build/x64-Release/_deps/pdcurses-src'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
